...
HD_PWD='C:/Users/SIDNEY/Documents/Xilinx/DVI_HDMI/DVI_HDMI/DVI_HDMI.runs/DVI_M_AXI_Lite_READ_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DVI_M_AXI_Lite_READ_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DVI_M_AXI_Lite_READ_0_3.tcl
