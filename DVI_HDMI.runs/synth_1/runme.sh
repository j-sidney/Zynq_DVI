...
HD_PWD='C:/Users/SIDNEY/Documents/Xilinx/DVI_HDMI/DVI_HDMI/DVI_HDMI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DVI_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DVI_wrapper.tcl
