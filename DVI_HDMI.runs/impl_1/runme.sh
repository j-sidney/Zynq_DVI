...
HD_PWD='C:/Users/SIDNEY/Documents/Xilinx/DVI_HDMI/DVI_HDMI/DVI_HDMI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DVI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DVI_wrapper.tcl -notrace
