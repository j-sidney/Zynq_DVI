...
HD_PWD='C:/Users/SIDNEY/Documents/Xilinx/DVI_HDMI/DVI_HDMI/DVI_HDMI.runs/DVI_TMDS_encoder_V2_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DVI_TMDS_encoder_V2_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DVI_TMDS_encoder_V2_1_0.tcl
